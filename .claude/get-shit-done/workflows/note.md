...
- **Global scope**: `/Users/aroman/Work/phantom-perp/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/aroman/Work/phantom-perp/.claude/notes/`)
...
2. Glob `/Users/aroman/Work/phantom-perp/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/aroman/Work/phantom-perp/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/aroman/Work/phantom-perp/.claude/notes/` — works in any directory
